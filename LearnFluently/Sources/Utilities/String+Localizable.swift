...
extension String {
    ...
    static let ERROR_CONVERT_SOURCE = "ERROR_CONVERT_SOURCE".localize()
    static let ERROR_CONVERT_SUBTITLES = "ERROR_CONVERT_SUBTITLES".localize()
    static let ERROR_RECOGNATION_NOT_AVAILABLE = "ERROR_RECOGNATION_NOT_AVAILABLE".localize()
    ...
    static let PLEASE_MAKE_SURE_SOURCE_SELECTED = "PLEASE_MAKE_SURE_SOURCE_SELECTED".localize()
    ...
    static let SOURCE_OPTION_SAMPLE = "SOURCE_OPTION_SAMPLE".localize()
    static let SOURCE_OPTION_YOUTUBE = "SOURCE_OPTION_YOUTUBE".localize()
    static let START_SPEAKING_HINT = "START_SPEAKING_HINT".localize()
